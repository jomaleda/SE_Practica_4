...
timeOut <= "11"; -- 12,5 MHz
	...
	--switches(0) <= WFIFO2IP_Data(9);
	--switches(1) <= WFIFO2IP_Data(10);
	--switches(2) <= WFIFO2IP_Data(11);
	--switches(3) <= WFIFO2IP_Data(12);
	--switches(4) <= WFIFO2IP_Data(13);
	--switches(5) <= WFIFO2IP_Data(14);
	--switches(6) <= WFIFO2IP_Data(15);
	--switches(7) <= WFIFO2IP_Data(16);
